...
| `scope` | What it may do: `ingest` (post events), `api` (read the [query API](api.md) and the [MCP server](mcp.md)), `dashboard` (open the [dashboard](dashboard.md)). A token may carry several. |
